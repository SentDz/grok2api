    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
		  ...
		  fieldImageConversationId: "Imagine 会话 ID。提供后图片编辑会续写 /conversations/{id}/responses；多区域编辑可仅传此字段。",
		  fieldImageParentResponseId: "可选的上一轮 Imagine 响应 ID，作为 parentResponseId；提供时必须同时传 conversation_id。",
		  ...
		  noteImageSegmentEdit: "图层选区走 selectionRegions。多段独立 prompt/参考图走 multiRegionEdits；传 conversation_id 时按已有 Imagine 会话续写，parent_response_id 可选。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
		  ...
		  fieldImageConversationId: "Imagine conversation ID. When provided, image edits continue /conversations/{id}/responses; multi-region edits may send this field alone.",
		  fieldImageParentResponseId: "Optional previous Imagine response ID, sent as parentResponseId. When provided, it must be paired with conversation_id.",
		  ...
		  noteImageSegmentEdit: "Layer selections map to selectionRegions. Independent prompts and references map to multiRegionEdits. conversation_id continues an existing Imagine session; parent_response_id is optional.",
