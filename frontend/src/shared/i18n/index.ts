    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          fieldSelectionRegions: "图层选区，outer.points 为 0–1 的 x,y 交替坐标。多个选区共用顶层 prompt，映射为上游 multiRegionEdits。不可与 multi_region_edits 同时使用。",
          ...
          noteImageSegmentEdit: "Web 2.0 分段编辑一律新建会话：selection_regions 与 multi_region_edits 都映射为 multiRegionEdits，并带 kind=CONVERSATION_KIND_IMAGINE 与 imageEditModel=imagine。",
    ...
    translation: {
      ...
      docs: {
        ...
        reference: {
          ...
          noteImageSegmentEdit: "Web 2.0 segmented edits always start a new conversation. Both selection_regions and multi_region_edits map to multiRegionEdits with kind=CONVERSATION_KIND_IMAGINE and imageEditModel=imagine.",
