...
export type AuditDTO = {
  ...
  egressScope?: "grok_build" | "grok_web" | "grok_web_submit" | "grok_console" | "grok_web_asset" | "grok_console_asset";
...
const auditValidator = hasShape({
  ...
  egressScope: isOptional(isOneOf("grok_build", "grok_web", "grok_web_submit", "grok_console", "grok_web_asset", "grok_console_asset")), egressMode: isOptional(isOneOf("direct", "proxy")),
