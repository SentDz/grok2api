...
var schemaIndexes = []string{
	...
	"CREATE INDEX IF NOT EXISTS idx_media_jobs_diagnostics_cleanup ON media_jobs(status, id, completed_at) WHERE status IN ('completed','failed') AND diagnostics <> '{}'",
